                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          style: TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.w400,
                            color: isLicenseAccepted ? Theme.of(context).textTheme.labelMedium?.color : kShadeOfGray,
                          ),
                          children: [
                            TextSpan(
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          style: TextStyle(
                            fontSize: 12,
                            fontWeight: FontWeight.w400,
                            color: isAnonymousDataEnabled ?  Theme.of(context).textTheme.labelMedium?.color : kShadeOfGray,
                          ),
                          children: [
                            TextSpan(
